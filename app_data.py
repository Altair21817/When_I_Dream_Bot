...
MESSAGE_CANT_BEGIN: str = (
    f'Для начала путешествия необходимо от {USERS_MIN} до {USERS_MAX} '
    'сновидцев. В настоящий момент их {users_count}.'
)
...
MESSAGE_JOIN_GAME_FAILED_TO_MUCH_USERS: str = (
    'О нет! В выбранной игре уже присутствует максимальное количество '
    'сновидцев!')
